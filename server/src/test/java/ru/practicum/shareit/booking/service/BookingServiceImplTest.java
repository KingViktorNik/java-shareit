...
class BookingServiceImplTest {
    ...
    void getAllByUserOwnerALL() {
        ...
        // when
        List<BookingDto> allByUserOwner = bookingService.getAllByUserOwner(user2.getId(), StatusBooking.ALL, 0, 10);
    ...
    void getAllByUserOwnerCurrent() {
        ...
        // when
        List<BookingDto> allByUserOwner = bookingService.getAllByUserOwner(user2.getId(), StatusBooking.CURRENT, 0, 10);
    ...
    void getAllByUserOwnerPast() {
        ...
        // when
        List<BookingDto> allByUserOwner = bookingService.getAllByUserOwner(user2.getId(), StatusBooking.PAST, 0, 10);
    ...
    void getAllByUserOwnerFuture() {
        ...
        // when
        List<BookingDto> allByUserOwner = bookingService.getAllByUserOwner(user2.getId(), StatusBooking.FUTURE, 0, 10);
    ...
    void getAllByUserOwnerWaitingPageSize1() {
        ...
        // when
        List<BookingDto> allByUserOwner = bookingService.getAllByUserOwner(user2.getId(), StatusBooking.WAITING, 0, 1);
    ...
    void getAllByUserOwnerRejected() {
        ...
        // when
        List<BookingDto> allByUserOwner = bookingService.getAllByUserOwner(user2.getId(), StatusBooking.REJECTED, 0, 10);
    ...
    void getAllBookingsByUserAll() {
        ...
        // when
        List<BookingDto> allByUserOwner = bookingService.getAllBookingsByUser(user1.getId(), StatusBooking.ALL, 5, 1);
    ...
    void getAllBookingsByUserCurrent() {
        ...
        // when
        List<BookingDto> allByUserOwner = bookingService.getAllBookingsByUser(user1.getId(), StatusBooking.CURRENT, 0, 10);
    ...
    void getAllBookingsByUserPast() {
        ...
        // when
        List<BookingDto> allByUserOwner = bookingService.getAllBookingsByUser(user1.getId(), StatusBooking.PAST, 0, 10);
    ...
    void getAllBookingsByUserFuture() {
        ...
        // when
        List<BookingDto> allByUserOwner = bookingService.getAllBookingsByUser(user1.getId(), StatusBooking.FUTURE, 0, 10);
    ...
    void getAllBookingsByUserWaitingPageSize1() {
        ...
        // when
        List<BookingDto> allByUserOwner = bookingService.getAllBookingsByUser(user1.getId(), StatusBooking.WAITING, 0, 1);
    ...
    void getAllBookingsByUserRejected() {
        ...
        // when
        List<BookingDto> allByUserOwner = bookingService.getAllBookingsByUser(user1.getId(), StatusBooking.REJECTED, 0, 10);
