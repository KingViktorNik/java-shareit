...
class BookingControllerTest {
    ...
    void getAllByUserOwner() throws Exception {
        when(bookingService.getAllByUserOwner(anyLong(), any(StatusBooking.class), anyInt(), anyInt()))
    ...
    void getAllBookingsByUser() throws Exception {
        when(bookingService.getAllBookingsByUser(anyLong(), any(StatusBooking.class), anyInt(), anyInt()))
                .thenReturn(List.of(bookingDto));
