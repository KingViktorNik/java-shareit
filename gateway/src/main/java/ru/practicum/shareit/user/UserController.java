...
public class UserController {
    ...
    public ResponseEntity<Object> newUser(@RequestBody @Valid UserDto userCreateDto) {
    ...
    public ResponseEntity<Object> updateUser(@PathVariable Long userId, @RequestBody @Valid UserUpdateDto userDto) {
    ...
    @GetMapping("{userId}")
    public ResponseEntity<Object> getByUserId(@PathVariable @NotNull Long userId) {
