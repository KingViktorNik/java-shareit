...
class UserServiceImplTest {
    ...
    void userUpdate() {
        ...
        UserDto userDto = makeUserDto("user1@mail.com", "user1");
        userDto = userService.newUser(userDto);
        UserUpdateDto userDtoNew = makeUserUpdateDto("user2@mail.com", "user1");
    ...
    void updateUserNameNull() {
        ...
        UserUpdateDto userUpdate = makeUserUpdateDto("user2@mail.com", null);
    ...
    void updateUserEmailNull() {
        ...
        UserUpdateDto userUpdate = makeUserUpdateDto(null, "user2");
    ...
    private UserUpdateDto makeUserUpdateDto(String email, String name) {
        return new UserUpdateDto(null, email, name);
    }
