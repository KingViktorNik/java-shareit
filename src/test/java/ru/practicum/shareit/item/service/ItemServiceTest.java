...
class ItemServiceTest {
    ...
    @Test
    void updateItemNullUserId() {
        // when
        final ValidationException exception = assertThrows(
                ValidationException.class,
                () -> itemService.updateItem(null, itemDto)
        );
    ...
    void itemAllByUserIdNull() {
        ...
        final ValidationException exception = assertThrows(
                ValidationException.class,
                () -> itemService.getByUserIdItemAll(null)
        );
    ...
    @Test
    void addCommentUserIdNull() {
        // when
        final ValidationException exception = assertThrows(
                ValidationException.class,
                () -> itemService.addComment(null, null, null)
        );
    ...
    void addComment() {
        ...
        // when
        CommentDto commentDto = itemService.addComment(1L, 1L, "text");
